  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        severity: {
          valid: "hsl(var(--severity-valid))",
          "valid-bg": "hsl(var(--severity-valid-bg))",
          "valid-border": "hsl(var(--severity-valid-border))",
          warning: "hsl(var(--severity-warning))",
          "warning-bg": "hsl(var(--severity-warning-bg))",
          "warning-border": "hsl(var(--severity-warning-border))",
